...
public class StepTracker {
    ...
    public void countingStatistic(int month) {
        printAllSteps(month);
        System.out.print("Сумма шагов за месяц составила " + sumStepsOnMonth(month));
        maxStepsOnMonth(month);
        averageStepsOnMonth(month);
        converter.distanceCalculation(sumStepsOnMonth(month));
        converter.caloriesCalculation(sumStepsOnMonth(month));
    ...
    public void printAllSteps(int month) {
        ...
        System.out.print("30 день: " + monthsAndDay[month][monthsAndDay[0].length - 1]);
    }
